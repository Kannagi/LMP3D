...
void AURAE_Clear()
{
	...
	gif[i++] = GS_SET_TEST(DRAW_DISABLE,ATEST_METHOD_EQUAL,0x80,ATEST_KEEP_ZB_ONLY,DRAW_DISABLE,DRAW_DISABLE,DRAW_ENABLE,ZTEST_METHOD_ALLPASS);
	gif[i++] = 0x47;
	...
	gif[i++] = GS_SET_XYZ((2048-360)<<4, (2048-256)<<4, 1024<<4);
	gif[i++] = GS_REG_XYZ2;
	...
	gif[i++] = GS_SET_TEST(DRAW_ENABLE,ATEST_METHOD_GREATER_EQUAL,0x80,ATEST_KEEP,DRAW_DISABLE,DRAW_DISABLE,DRAW_ENABLE,ZTEST_METHOD_GREATER_EQUAL );
	gif[i++] = 0x47;
